...
const Landing: FC<LandingProps> = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id='home'
      className='md:flex md:justify-between md:items-center md:h-full  md:gap-8 lg:gap-16   py-10'
      onMouseOver={() => setSelectedPage('home')}
    >
      {/* IMAGE SECTION */}
      <div className='md:order-2 flex justify-center md:basis-2/5 lg:basis-3/5 z-10 mt-16 md:mt-32'>
      ...
      {/* MAIN SECTION */}
      <div className='z-30 md:basis-3/5 lg:basis-2/5 mt-12 md:mt-32'>
        {/* HEADINGS */}
        <motion.div
          initial='hidden'
          whileInView='visible'
        ...
        >
          ...
          <p className='mt-10 mb-7 text-sm text-center md:text-start xs:text-lg sm:text-xl'>
